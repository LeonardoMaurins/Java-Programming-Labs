...
public class MakeFamilyRobinson {
	...
	public static void main(String[] args) throws FirstNameExistsException {
		...
		Person member5 = new Person("John","Robinson"); // First name "John already exists"
//		
//		Person member6 = new Person("Jessy","James"); // Surname not Robinson
