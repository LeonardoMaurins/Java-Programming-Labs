...
public class MainWindow extends JFrame implements ActionListener {
	...
	public MainWindow() {
		...
		list1.setBorder(BorderFactory.createLineBorder(Color.gray));
		list2 = new JList(listData);
		list2.setBorder(BorderFactory.createLineBorder(Color.gray));
		list3 = new JList(listData);
		list3.setBorder(BorderFactory.createLineBorder(Color.gray));
		...
		// Setup a panel with a FlowLayout for the buttons and add it to the
		// BorderLayout
