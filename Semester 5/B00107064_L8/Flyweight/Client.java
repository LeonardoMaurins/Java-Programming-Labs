...
public class Client extends JFrame implements MouseMotionListener {
	...
	// The constructor class which instantiates functions in the class
	public Client() {
	...
	// Creates folders based off the name size
	...
	// Adds names to the folders in the structure
	...
	// Paint function that adds names to the folder structures
	...
	// Mouse action for the interface to react
