...
public class MenuBar9 extends JFrame implements ActionListener {
	...
	public MenuBar9() {
		...
		// add the software and Hardware manu itemsn to the Help menu item
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() instanceof JMenuItem) {
			...
			if (e.getActionCommand().equals("New"))
				message = "The New Item was selected";
			else if (e.getActionCommand().equals("Open"))
				message = "The Open Item was selected";

			JOptionPane.showMessageDialog(null, message,
					"The Menu was clicked", JOptionPane.PLAIN_MESSAGE);
